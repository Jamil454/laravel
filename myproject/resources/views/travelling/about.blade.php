    ...
    <div class="container">
      <div class="row">
        <div class="slider-content">
          <div class="row">
            <div class="col-lg-12">
              <h2><em>{{$country->name}}'s Cities &amp; Towns</em></h2>
            </div>
            <div class="col-lg-12">
          ...
          <div class="owl-weekly-offers owl-carousel">
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{asset('assets/images/'.$city->image)}}" alt="">
                <div class="text">
                  <h4 class="text-black">{{$city->name}}<br><span><i class="fa fa-users"></i> 234 Check Ins</span></h4>
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="section-heading">
            <h2 class="text-white">Discover More About Our Country</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
          </div>
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="info-item">
                <div class="row">
                  <div class="col-lg-6">
                    <h4 class="text-black">{{$citiesCount}}+</h4>
