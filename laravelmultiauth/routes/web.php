...
Route::middleware('auth:admin')->prefix('admin')->group( function () {
    ...
    Route::post('logout', [App\Http\Controllers\Auth\Teacher\LoginController::class, 'destroy'])->name('admin.logout');
...
Route::middleware('guest:teacher')->prefix('teacher')->group( function () {
    ...
    Route::get('login', [App\Http\Controllers\Auth\Admin\LoginController::class, 'login'])->name('teacher.login');
